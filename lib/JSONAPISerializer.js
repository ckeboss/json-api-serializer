          ...
          if (Array.isArray(relationship.data)) {
            set(
              ...
              relationship.data.map(d => {
                const circular = lineage.find(value => {
                  return value.id === d.id && value.type === d.type;
                });
            ...
            const circular = lineage.find(value => {
              return value.id === relationship.data.id && value.type === relationship.data.type;
            });
